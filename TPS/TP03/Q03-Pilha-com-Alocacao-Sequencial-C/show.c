...
void pilha_inserir(Pilha *pilha, Show *show) {
    if (pilha->n < MAX_CAPACITY) {
        pilha->array[pilha->n++] = show;
    }
}

Show *pilha_remover(Pilha *pilha) {
    if (pilha->n > 0) {
