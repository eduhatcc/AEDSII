...
class Principal {
	public static void main(String[] args) {
      ...
      //Mostrar o conjunto ordenado, tempo de execucao e status da ordenacao
		...
		System.out.println("Numero de comparações inserção fora: " + algoritmo.contComp1); 
		System.out.println("Numero de comparações inserção dentro: " + algoritmo.contComp2);
		System.out.println("Numero de comparações quicksort primeiro while: " + algoritmo.contComp3);
		System.out.println("Numero de comparações quicksort segundo while: " + algoritmo.contComp4);
